...
class SnsUserCorrectActivityViewModel(application: Application) : AndroidViewModel(application) {
        ...
        signUpInterface.postUserCorrect(userUid, param)
            .enqueue(object : Callback<UserCorrectResponse> {
                override fun onResponse(
                    call: Call<UserCorrectResponse>,
                    response: Response<UserCorrectResponse>
                ) {
