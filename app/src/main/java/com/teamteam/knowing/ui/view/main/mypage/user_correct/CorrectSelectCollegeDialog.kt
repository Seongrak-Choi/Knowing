...
import com.teamteam.knowing.databinding.DialogSelectCollegeBinding
import com.teamteam.knowing.ui.adapter.SelectCollegeDialogRCAdapter
import com.teamteam.knowing.ui.adapter.SelectDoDialogRCAdapter
import com.teamteam.knowing.ui.viewmodel.MoreInformationActivity3ViewModel
import com.teamteam.knowing.ui.viewmodel.MoreInformationCorrectActivityViewModel

class CorrectSelectCollegeDialog  : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        moreInformationCorrectActivityViewModel.currentCollegeNameList.observe(this, Observer {
            ...
            adapter.setOnItemClickListener(object : SelectDoDialogRCAdapter.OnItemClickListener {
                override fun onItemClick(value: String) {
                    moreInformationCorrectActivityViewModel.currentSelectTxCollegeName.value =
        ...
        binding.edtSearch.setOnEditorActionListener { textView, i, keyEvent ->
            if (i === EditorInfo.IME_ACTION_DONE) {
                ...
                moreInformationCorrectActivityViewModel.tryGetCollege(
