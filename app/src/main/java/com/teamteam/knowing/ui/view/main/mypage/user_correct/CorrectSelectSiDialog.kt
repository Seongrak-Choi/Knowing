...
import com.teamteam.knowing.databinding.DialogSelectSiBinding
...
class CorrectSelectSiDialog: DialogFragment(){
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        //뷰모델 장착
        moreInformationCorrectActivityViewModel=ViewModelProvider(requireActivity()).get(MoreInformationCorrectActivityViewModel::class.java)
        ...
        moreInformationCorrectActivityViewModel.siList.observe(this, Observer {
            ...
            adapter.setOnItemClickListener(object:SelectDoDialogRCAdapter.OnItemClickListener{
                override fun onItemClick(value: String) {
                    moreInformationCorrectActivityViewModel.currentTxSi.value=value //리사이클러뷰에서 선택되어진 데이터를 뷰모델의 currentTxSi에 저장
                    moreInformationCorrectActivityViewModel.isSelectSi.value=true //리사이클러뷰에서 시/군/구가 선택되어지면 선택이 되었다고 뷰모델의 isSelectSi에 true저장
