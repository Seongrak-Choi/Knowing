package com.teamteam.knowing.ui.view.login
...
import com.teamteam.knowing.databinding.ActivityJoinUpSnsBinding
import com.teamteam.knowing.ui.base.BaseActivity
import com.teamteam.knowing.ui.view.sign_in.SignInActivity
import com.teamteam.knowing.ui.view.sign_up.SignUpActivity
import com.teamteam.knowing.ui.viewmodel.JoinUpSNSActivityViewModel
...
//            }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) { //구글 로그인 인증을 요청 했을 때 결과 값을 되돌려 받는 곳.
        ...
        if(requestCode== REQ_SIGN_GOOGLE){
            ...
            Log.d("INFO","Google계정으로 로그인 결과 값 : ${result.isSuccess}")
        ...
        LoginManager.getInstance()
            .registerCallback(callbackManager, object: FacebookCallback<LoginResult> {
                ...
                override fun onCancel() {
                    Log.d("FacebookError","사용자가 로그인 도중 취소")
                }
                override fun onError(error: FacebookException?) {
                    Log.d("FacebookError", error.toString())
                    Toast.makeText(applicationContext,"아직 개발 모드 입니다.",Toast.LENGTH_SHORT).show()
                }
            })
    }
