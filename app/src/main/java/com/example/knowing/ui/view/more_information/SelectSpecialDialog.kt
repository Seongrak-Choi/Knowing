...
import com.example.knowing.databinding.DialogSelectSpecialBinding
...
class SelectSpecialDialog() : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        moreInformationActivity1ViewModel.currentBtnSmallBusiness.observe(this, Observer {
            if (it){
        ...
        moreInformationActivity1ViewModel.currentBtnLowIncome.observe(this, Observer {
            if (it){
        ...
        moreInformationActivity1ViewModel.currentBtnDisabled.observe(this, Observer {
            if (it){
        ...
        moreInformationActivity1ViewModel.currentBtnFarmer.observe(this, Observer {
            if (it){
        ...
        moreInformationActivity1ViewModel.currentBtnSolider.observe(this, Observer {
            if (it){
        ...
        moreInformationActivity1ViewModel.currentBtnLocalTalent.observe(this, Observer {
            if (it){
        ...
        moreInformationActivity1ViewModel.isSpecialDialogCorrect.observe(this, Observer {
        ...
        binding.btnCancel.setOnClickListener {
            ...
            moreInformationActivity1ViewModel.getCheckedBtnInfo()
            dialog?.cancel()
            dialog?.dismiss()
        }
        ...
        override fun onClick(v: View?) {
            when(v){
                binding.btnSmallBusiness->
                    moreInformationActivity1ViewModel.changeBtnSmallBusiness()
                binding.btnLowIncome->
                    moreInformationActivity1ViewModel.changeBtnLowIncome()
                binding.btnDisabled->
                    moreInformationActivity1ViewModel.changeBtnDisabled()
                binding.btnFarmers->
                    moreInformationActivity1ViewModel.changeBtnFarmer()
                binding.btnSoldier->
                    moreInformationActivity1ViewModel.changeBtnSolider()
                binding.btnLocalTalent->
                    moreInformationActivity1ViewModel.changeBtnLocalTalent()
            }
        }
    }
}