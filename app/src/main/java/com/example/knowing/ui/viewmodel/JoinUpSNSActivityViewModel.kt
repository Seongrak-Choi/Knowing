...
import com.example.knowing.data.model.network.response.GFDLoginResponse
import com.example.knowing.data.model.network.response.KakaoLoginResponse
import com.example.knowing.data.model.network.response.NaverLoginResponse
import com.example.knowing.data.remote.api.CollegeInterface
import com.example.knowing.data.remote.api.JoinUpSNSInterface
import com.example.knowing.ui.view.login.JoinUpSNSActivity
import com.example.knowing.ui.view.main.LoadingActivity
import com.example.knowing.ui.view.sign_up.SnsSignUpActivity
...
//                }
    ...
    fun tryGetNaverCustomToken(naver_access_token:String){
        ...
        collegeInterface.getNaverCustomToken(naver_access_token).enqueue(object:
